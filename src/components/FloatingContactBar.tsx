...
export default function FloatingContactBar() {
  ...
  return (
    <>
      ...
      {/* Modal de Formulário */}
      {showForm && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-brand-navy-900/80 backdrop-blur-sm">
          <div className="relative w-full max-w-md bg-brand-navy-800 border border-white/10 rounded-2xl shadow-2xl p-6 md:p-8">
            <button
              onClick={() => {
                setShowForm(false);
                setFormData({ nome: "", telefone: "" });
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-6 py-3 rounded-lg border border-white/20 bg-white/5 text-white hover:bg-white/10 transition-all"
                >
                  Cancelar
                </button>
              </div>
