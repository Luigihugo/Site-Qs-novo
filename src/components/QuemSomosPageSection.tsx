...
export default function QuemSomosPageSection() {
  ...
  const benefits = [
    ...
    {
      icon: "👥",
      title: "Time multidisciplinar sênior",
      description: "Especialistas contábeis-fiscais, jurídicos e empresariais",
    },
    {
      icon: "🎯",
      title: "Foco em resultados",
      description: "Entrega com velocidade e ROI mensurável",
    },
  ];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-brand-blue-100/80 max-w-3xl mx-auto leading-relaxed">
            Transformamos desafios em oportunidades através da eficiência que geramos. 
            Com metodologia comprovada e tecnologia de ponta, entregamos resultados mensuráveis 
            que impactam diretamente no crescimento e na proteção patrimonial dos nossos clientes.
          </p>
        </div>
          ...
          {metrics.map((metric, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="text-lg md:text-xl text-brand-blue-500 font-semibold">
                  {metric.label}
                </div>
        ...
        {/* Benefits Grid - Balões de eficiência */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-brand-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
